    ...
    <div id="payment">
          ...
          <MSection :id="'payment-proccess'">
             ...
             <div class="payment-section">
                  ...
                  <div v-if="currentProduct.projectID == 'topup'" class="col estimation-product">
                    ...
                    <div class="estimation-item-row">
                        ...
                        <p>{{currentProduct.API_TYPE == 'topup' ? 'Пополнение счета' : currentProduct.API_TYPE }}</p>
                    </div>
                  </div>
                  <div v-if="currentProduct.projectID != 'topup'" class="col estimation-product">
                     <div class="estimation-item-row">
                ...
                <div class="row">
                                    <MButton :btnClass="'btn btn-regular'" @click="toHome">Главная</MButton>
                <MButton :btnClass="'btn btn-regular'" @click="toHome">В каталог</MButton>
                <MButton v-if="data.status == 'COMPLETED'" :btnClass="'btn btn-regular'" @click="generatePDF">Квитанция</MButton>
                </div>
             </div>
...
export default {
    ...
    computed:{
        ...mapState(["accessToken", "currentProduct"]),
    },
    methods:{
        getWallet(){
                        let options = {
        ...
        getProjects(){
            ...
            this.$http(options)
            .then(res=>this.$store.commit('SAVE_PROJECTS',res.data))
        },
        getUserProjects(){
            let options = {
        ...
        doIncrease(){
            ...
            this.$http(options)
            .then(res=>(console.log(res.data, 'INCREASED')))
        },
        doTopUp(){
            let options = {
        ...
        doPay(){
            ...
            this.$http(options)
            .then(res=>(console.log(res.data, 'BOUGHT')))
        },
        toHome(){
    ...
    generatePDF(){
        ...
        const doc = new jsPDF({
            ...
            if(this.currentProduct.API_TYPE == 'buy' || this.currentProduct.API_TYPE == 'increase'){
